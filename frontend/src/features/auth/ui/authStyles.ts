export const authStyles = {
  ...
  title: [
    'm-0 text-2xl leading-[1.3] font-bold tracking-heading',
    'text-ink',
  ].join(' '),
  subtitle: [
    'mt-2.5 mb-0 text-control leading-normal font-normal',
    'text-ink-muted',
  ].join(' '),
  ...
  error: 'm-0 text-xs leading-normal text-danger',
  switchText:
    'm-0 text-center text-label leading-normal text-ink-muted',
  link: [
